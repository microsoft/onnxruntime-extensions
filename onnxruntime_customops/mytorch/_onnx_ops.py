...
def _create_name_or_use_existing_one(self, op_type, name):
    if name is None:
        return self.get_unique_operator_name(op_type)
    else:
        return name
...
class ONNXGraphBuilder:
    ...
    def _apply_unary_operation(self, op_type, input_name, output_name, container, operator_name, **attrs):
        name = _create_name_or_use_existing_one(self, op_type, operator_name)
    ...
    def abs(self, input_name, output_name, container, operator_name=None):
        self.self._apply_unary_operation('Abs', input_name, output_name, container, operator_name=operator_name)
    ...
    def argmax(self, input_name, output_name, container, operator_name=None, axis=0, keepdims=1,
                     select_last_index=0):
        name = _create_name_or_use_existing_one(self, 'ArgMax', operator_name)
    ...
    def apply_argmin(self, input_name, output_name, container, operator_name=None, axis=0, keepdims=1,
                     select_last_index=0):
        name = _create_name_or_use_existing_one(self, 'ArgMin', operator_name)
        attrs = {'axis': axis, 'keepdims': keepdims}
        if container.target_opset < 11:
            op_version = 1
        elif container.target_opset < 12:
    ...
    def apply_batch_norm(self, input_names, output_names, container, operator_name=None,
        ...
        name = _create_name_or_use_existing_one(self, 'BatchNormalization', operator_name)
    ...
    def apply_cast(self, input_name, output_name, container, operator_name=None, to=None):
        ...
        """
        name = _create_name_or_use_existing_one(self, 'Cast', operator_name)
        attrs = {'name': name}
    ...
    def apply_clip(self, input_name, output_name, container, operator_name=None, max=None, min=None):
        name = _create_name_or_use_existing_one(self, 'Clip', operator_name)
        attrs = {'name': name}
        ...
        if container.target_opset < 11:
            ...
            if min is not None:
                if isinstance(min, (np.ndarray, float, int)):
                    ...
                    # container.dtype.
                    min_name = self.get_unique_variable_name('clip_min')
                    if op_version < 12:
            ...
            if max is not None:
                ...
                if isinstance(max, (np.ndarray, float, int)):
                    ...
                    max_name = self.get_unique_variable_name('clip_max')
                    if op_version < 12:
    ...
    def apply_concat(self, input_names, output_name, container, operator_name=None, axis=0):
        name = _create_name_or_use_existing_one(self, 'Concat', operator_name)
    ...
    def apply_constant(self, output_name, container, operator_name=None, value=None):
        name = _create_name_or_use_existing_one(self, 'Constant', operator_name)
    ...
    def apply_constant_of_shape(self, input_names, output_name, container, operator_name=None, value=None):
        name = _create_name_or_use_existing_one(self, 'ConstantOfShape', operator_name)
    ...
    def apply_conv(self, input_names, output_name, container, operator_name=None, **attrs):
        name = _create_name_or_use_existing_one(self, 'Conv', operator_name)
    ...
    def apply_crop_height_width(self, input_name, output_name, container, operator_name=None,
        ...
        if container.target_opset < 9:
            ...
            axes = [2, 3]
            axes_name = self.get_unique_variable_name(name + '_axes')
            ...
            starts_name = self.get_unique_variable_name(name + '_starts')
            ...
            ends_name = self.get_unique_variable_name(name + '_ends')
    ...
    def apply_equal(self, input_names, output_name, container, operator_name=None):
        name = _create_name_or_use_existing_one(self, 'equal', operator_name)
        if container.target_opset < 7:
            op_version = 1
        elif container.target_opset < 9:
            op_version = 7
    ...
    def apply_flatten(self, input_name, output_name, container, operator_name=None, axis=1):
        name = _create_name_or_use_existing_one(self, 'Flatten', operator_name)
        if container.target_opset < 9:
            op_version = 1
        elif container.target_opset < 11:
            op_version = 9
    ...
    def apply_gather(self, input_names, output_name, container, operator_name=None, axis=0):
        name = _create_name_or_use_existing_one(self, 'Gather', operator_name)
        if container.target_opset < 11:
            op_version = 1
        else:
            op_version = 11
    ...
    def apply_gemm(self, input_name, output_name, container, operator_name=None, alpha=1.0, beta=1.0,
        ...
        """
        name = _create_name_or_use_existing_one(self, 'Gemm', operator_name)
    ...
    def apply_greater(self, input_names, output_name, container, operator_name=None):
        name = _create_name_or_use_existing_one(self, 'Greater', operator_name)
        if container.target_opset < 7:
            op_version = 1
        elif container.target_opset < 9:
            op_version = 7
    ...
    def _convert_compare_equal(self, input_names, output_name, container, operator_name, tf_op_string, onnx_op_string_rev,
        ...
        if container.target_opset < 7:
            ...
            op_version = 12
        name = _create_name_or_use_existing_one(self, tf_op_string, operator_name)
        if op_version < 9:
            compare_input_0 = self.get_unique_variable_name(name + '_input_0_cast')
            container.add_node('Cast', [input_names[0]], compare_input_0, name=name + '_input_0_cast', to=1)
            compare_input_1 = self.get_unique_variable_name(name + '_input_1_cast')
            container.add_node('Cast', [input_names[1]], compare_input_1, name=name + '_input_1_cast', to=1)
            less_out = self.get_unique_variable_name(name + '_less_out')
            ...
            compare_node = self.get_unique_variable_name(name + '_compare_node')
    ...
    def apply_gru(self, input_names, output_names, container, operator_name=None, output_seq=0, reset_after=0, **attrs):
        name = _create_name_or_use_existing_one(self, 'GRU', operator_name)
    ...
    def apply_identity(self, input_name, output_name, container, operator_name=None):
        name = _create_name_or_use_existing_one(self, 'Identity', operator_name)
    ...
    def apply_instance_norm(self, input_names, output_name, container, operator_name=None, epsilon=1e-5):
        name = _create_name_or_use_existing_one(self, 'InstanceNormalization', operator_name)
    ...
    def apply_inverse(self, input_name, output_name, container, operator_name=None):
        if container.target_opset < 12:
            ...
            op_version = 12
        name = _create_name_or_use_existing_one(self, 'Inverse', operator_name)
    ...
    def apply_less(self, input_names, output_name, container, operator_name=None):
        name = _create_name_or_use_existing_one(self, 'Less', operator_name)
        if container.target_opset < 7:
            op_version = 1
        elif container.target_opset < 9:
            op_version = 7
    ...
    def apply_lstm(self, input_names, output_names, container, operator_name=None, output_seq=0, **attrs):
        name = _create_name_or_use_existing_one(self, 'LSTM', operator_name)
        if container.target_opset <= 6:
            attrs['output_sequence'] = 1 if output_seq else 0
            op_version = 1
        else:
    ...
    def apply_max(self, input_names, output_name, container, operator_name=None):
        _apply_pointwise_operation(self, 'Max', input_names, output_name, container, operator_name)
    
    
    def apply_mean(self, input_names, output_name, container, operator_name=None):
        _apply_pointwise_operation(self, 'Mean', input_names, output_name, container, operator_name)
    
    
    def apply_min(self, input_names, output_name, container, operator_name=None):
        _apply_pointwise_operation(self, 'Min', input_names, output_name, container, operator_name)
    ...
    def apply_normalization(self, input_name, output_name, container, operator_name=None, axis=1, p=2):
        name = _create_name_or_use_existing_one(self, 'LpNormalization', operator_name)
    ...
    def apply_pad(self, input_name, output_name, container, operator_name=None, mode=None, pads=None, value=None,
        ...
        name = _create_name_or_use_existing_one(self, 'Pad', operator_name)
        attrs = {'name': name}
        ...
        if container.target_opset < 11:
            ...
            if isinstance(pads, str):
                ...
                pads_name = self.get_unique_variable_name(name + '_pads')
                container.add_initializer(pads_name, onnx_proto.TensorProto.INT64, [len(pads)], pads)
                inputs.append(pads_name)
            if value is not None:
                value_name = self.get_unique_variable_name(name + '_value')
    ...
    def apply_parametric_softplus(self, input_name, output_name, container, operator_name=None, alpha=None, beta=None):
        ...
        name = _create_name_or_use_existing_one(self, 'ParametricSoftplus', operator_name)
        if container.target_opset < 9:
            ...
            oneName = self.get_unique_variable_name(name + '_one')
            container.add_initializer(oneName, onnx_proto.TensorProto.FLOAT, [1], [1.])
    
            # c = b * x
            cName = self.get_unique_variable_name(name + '_c')
            apply_mul(self, [input_name, bName], cName, container)
    
            # d = exp(c)
            dName = self.get_unique_variable_name(name + '_d')
            apply_exp(self, cName, dName, container)
    
            # e = 1 + d
            eName = self.get_unique_variable_name(name + '_e')
            apply_add(self, [dName, oneName], eName, container)
    
            # f = log(e)
            fName = self.get_unique_variable_name(name + '_f')
    ...
    def apply_pow(self, input_names, output_name, container, operator_name=None, axis=None, broadcast=None):
        name = _create_name_or_use_existing_one(self, 'Pow', operator_name)
    ...
    def apply_prelu(self, input_name, output_name, container, operator_name=None, slope=None):
        name = _create_name_or_use_existing_one(self, 'PRelu', operator_name)
        slope_tensor_name = self.get_unique_variable_name('slope')
        s_shape = slope.shape
        if container.target_opset < 7:
    ...
    def apply_range(self, input_name, output_name, container, operator_name=None):
        name = _create_name_or_use_existing_one(self, 'Range', operator_name)
    ...
    def apply_reducesum(self, input_name, output_name, container, operator_name=None, axes=None, keepdims=1, rank=0):
        name = _create_name_or_use_existing_one(self, 'ReduceSum', operator_name)
        if axes is None:
            axes = []
        if container.target_opset < 13:
            ...
            if isinstance(axes, str):
                ...
                axes_name = self.get_unique_variable_name(name + '_reducesum')
    ...
    def apply_relu_6(self, input_name, output_name, container, operator_name=None, zero_value=0.0):
        name_relu = _create_name_or_use_existing_one(self, 'relu', operator_name)
        name_relu_op = _create_name_or_use_existing_one(self, 'relu6', operator_name)
    ...
    def apply_reshape(self, input_name, output_name, container, operator_name=None, desired_shape=None):
        ...
        name = _create_name_or_use_existing_one(self, 'Reshape', operator_name)
        ...
        if container.target_opset < 5:
            ...
            if isinstance(desired_shape, str):
                ...
                desired_shape_name = self.get_unique_variable_name('shape_tensor')
    ...
    def apply_resize(self, input_name, output_name, container, operator_name=None, mode='nearest',
        ...
        """
        name = _create_name_or_use_existing_one(self, 'Resize', operator_name)
        attrs = {'name': name}
        ...
        if container.target_opset < 11:
            ...
            op_version = 11
            roi_tensor_name = self.get_unique_variable_name(name + '_roi')
        ...
        scales_tensor_name = self.get_unique_variable_name(name + '_scales')
    ...
    def apply_rnn(self, input_names, output_names, container, operator_name=None, output_seq=0, **attrs):
        name = _create_name_or_use_existing_one(self, 'RNN', operator_name)
        if container.target_opset <= 6:
            attrs['output_sequence'] = 1 if output_seq else 0
            op_version = 1
        else:
    ...
    def apply_shape(self, input_name, output_name, container, operator_name=None):
        name = _create_name_or_use_existing_one(self, 'Shape', operator_name)
    ...
    def apply_softsign(self, input_name, output_name, container, operator_name=None):
        name = _create_name_or_use_existing_one(self, 'Softsign', operator_name)
    ...
    def apply_softmax(self, input_name, output_name, container, operator_name=None, axis=None):
        name = _create_name_or_use_existing_one(self, 'Softmax', operator_name)
        if axis is None:
    ...
    def apply_scaled_tanh(self, input_name, output_name, container, operator_name=None, alpha=None, beta=None):
        ...
        name = _create_name_or_use_existing_one(self, 'ScaledTanh', operator_name)
        if container.target_opset < 9:
            attrs = {'name': name, 'alpha': alpha[0], 'beta': beta[0]}
    ...
    def apply_slice(self, input_name, output_name, container, starts, ends,
                    axes=None, steps=None, operator_name=None):
        name = _create_name_or_use_existing_one(self, 'Slice', operator_name)
        ...
        if container.target_opset < 10:
            ...
            if isinstance(starts, str):
                ...
                starts_name = self.get_unique_variable_name('starts')
                container.add_initializer(starts_name, onnx_proto.TensorProto.INT64,
                                          [len(starts)], starts)
            ...
            if isinstance(ends, str):
                ...
                ends_name = self.get_unique_variable_name('ends')
                container.add_initializer(ends_name, onnx_proto.TensorProto.INT64,
                                          [len(ends)], ends)
            ...
            if axes:
                if isinstance(axes, str):
                    ...
                    axes_name = self.get_unique_variable_name('axes')
                    container.add_initializer(axes_name, onnx_proto.TensorProto.INT64,
                                              [len(axes)], axes)
            ...
            if steps:
                ...
                if isinstance(steps, str):
                    ...
                    steps_name = self.get_unique_variable_name('steps')
    ...
    def apply_slice2(self, input_name, output_name, container,
        ...
        return apply_slice(self, input_name, output_name, container, starts, ends,
                           axes, steps, operator_name)
    
    
    def apply_split(self, input_name, output_names, container, operator_name=None, split=None, axis=0):
        name = _create_name_or_use_existing_one(self, 'Split', operator_name)
        ...
        if split is not None:
            if container.target_opset < 13:
                ...
                if isinstance(split, str):
                    ...
                    split_name = self.get_unique_variable_name(name + '_split')
    ...
    def _apply_squeeze_unsqueeze(self, input_name, output_name, container, squeeze_str, operator_name=None, axes=None,
                                 rank=0):
        name = _create_name_or_use_existing_one(self, squeeze_str, operator_name)
        if container.target_opset < 13:
            if container.target_opset < 11:
                op_version = 1
                axes = [axis if axis >= 0 else axis + rank for axis in axes]
    ...
    def apply_squeeze(self, input_name, output_name, container, operator_name=None, axes=None, rank=0):
        if axes is None:
            axes = []
        _apply_squeeze_unsqueeze(self, input_name, output_name, container, 'Squeeze', operator_name, axes, rank)
    
    
    def apply_sub(self, input_names, output_name, container, operator_name=None, axis=None, broadcast=0):
        _apply_basic_numerical_operation(self, 'Sub', input_names, output_name, container, operator_name=operator_name,
                                         axis=axis, broadcast=broadcast)
    
    
    def apply_sum(self, input_names, output_name, container, operator_name=None):
        name = _create_name_or_use_existing_one(self, 'Sum', operator_name)
        if container.target_opset < 6:
            op_version = 1
        else:
            op_version = 6
    ...
    def apply_thresholded_relu(self, input_name, output_name, container, operator_name=None, alpha=None):
        ...
        name = _create_name_or_use_existing_one(self, 'ThresholdedRelu', operator_name)
    ...
    def apply_tile(self, input_name, output_name, container, operator_name=None, repeats=None):
        name = _create_name_or_use_existing_one(self, 'Tile', operator_name)
        ...
        if container.target_opset < 6:
            ...
            for axis, repeat_count in enumerate(repeats):
                ...
                intermediate_output_name = self.get_unique_variable_name(name + '_input')
            ...
            if isinstance(repeats, str):
                ...
                repeat_tensor_name = self.get_unique_variable_name(name + '_repeats')
    ...
    def apply_topk(self, input_name, output_names, container, k, operator_name=None):
        name = _create_name_or_use_existing_one(self, 'TopK', operator_name)
        ...
        if container.target_opset < 10:
            ...
            if isinstance(k, str):
                ...
                k_value_name = self.get_unique_variable_name('k_value')
    ...
    def apply_transpose(self, input_name, output_name, container, operator_name=None, perm=None):
        name = _create_name_or_use_existing_one(self, 'Transpose', operator_name)
    ...
    def apply_upsample(self, input_name, output_name, container, operator_name=None, mode='nearest',
        ...
        """
        if container.target_opset < 10:
            name = _create_name_or_use_existing_one(self, 'Upsample', operator_name)
            inputs = [input_name]
            attrs = {'name': name}
            if container.target_opset < 7:
                if len(scales) != 4:
