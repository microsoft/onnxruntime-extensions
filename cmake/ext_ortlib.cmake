...
elseif(ONNXRUNTIME_PKG_DIR)
  # Use the externally provided ONNX Runtime headers and libs if available
  if (NOT ONNXRUNTIME_INCLUDE_DIR)
    message(FATAL_ERROR "ONNXRUNTIME_INCLUDE_DIR is not set")
  endif()

  message(FATAL_ERROR ${ONNXRUNTIME_INCLUDE_DIR})
  ...
  message(STATUS "ONNX Runtime Extensions: Using ONNX Runtime headers from ${ONNXRUNTIME_INCLUDE_DIR}")
  message(STATUS "ONNX Runtime Extensions: Using ONNX Runtime libs from ${ONNXRUNTIME_LIB_DIR}")
