...
# Generate new docs
$1/python -m sphinx -j1 -v -T -b html -d $3/docs/extensions/_doctrees/html $2/docs/python/ $3/docs/extensions/html
$1/python -u $2/tools/doc/rename_folders.py $3/docs/extensions/html
