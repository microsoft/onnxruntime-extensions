...
struct GroupQueryAttention {
  ...
  OrtStatusPtr Compute(OrtKernelContext* kernel_context, const Ort::Custom::CudaContext& ctx, const ortc::Tensor<T>& query, std::optional<const ortc::Tensor<T>*> key,
    ...
    IAllocatorUniquePtr<void> softmax_lse_accum_buffer = nullptr;
    IAllocatorUniquePtr<void> out_accum_buffer = nullptr;
#endif
    ...
    IAllocatorUniquePtr<void> v_buffer = nullptr;
    IAllocatorUniquePtr<void> fmha_buffer = nullptr;
#endif
